...
if (movieInput === "") {
  console.log(`The movie is null! No spoilers for null!`)
  return
} else {
  //Spoiler time wait
  var spoilerTimer = Number(readlineSync.question('Enter wait time to your spoiler? '));
  //spoiler warning
  ...
  request(url, function (error, response, body) {
    if (!error) {
      ...
      console.log(`Read some news about ${movieInput}:`)
